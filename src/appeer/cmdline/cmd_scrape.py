...
Example usage: appeer scrape -c -ds "My scrape description" PoP.json
...
@click.option('-ds', '--description', 'description', default=None, help="Optional description of the scrape job")
